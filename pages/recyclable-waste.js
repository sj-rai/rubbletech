...
import recyclable from "../public/recyclable.jpeg"

export default function BiomedicalWaste() {
    return (
        <Layout>
            <div className={styles.container1}>
                <Image height='400px' width='1000px' alt='food-waste' src={recyclable} />
            </div>
            <div className={`${styles.container} ${styles.pages}`}>
                ...
                <br />
                <Accordion>
                    <AccordionItem title="What is Recyclable waste">
                        <p>
